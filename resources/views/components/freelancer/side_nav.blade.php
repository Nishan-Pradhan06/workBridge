...
<div class="container">
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <h5>User Settings</h5>
            <a href="/freelancer/setting/profile" class="nav-item"><i class="fas fa-user icons"></i> My Profile</a>
            <a href="/freelancer/setting/contactInfo" class="nav-item"><i class="fas fa-address-book icons"></i> Contact Info</a>
            <a href="/freelancer/setting/password-and-security" class="nav-item"><i class="fas fa-lock icons"></i> Password & Security</a>
        </nav>
    </aside>
    @yield('main')
</div>